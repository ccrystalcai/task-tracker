  ...
  return (
    <header className="h-16 border-b border-border bg-surface flex items-center justify-between px-6">
      <div>
        ...
        <p className="text-caption text-text-secondary flex items-center gap-1 mt-0.5">
          <Calendar size={13} />
          {today}
        </p>
      </div>
      ...
      <Link
        to="/search"
        className="flex items-center gap-2 px-4 py-2 rounded-btn border border-border text-text-secondary hover:text-text-primary hover:bg-surface-hover transition-colors"
      >
        <Search size={18} />
